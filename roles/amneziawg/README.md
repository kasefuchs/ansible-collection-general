...
| [Download AmneziaWG kernel module](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/download.yml#L10) | ansible.builtin.include_role | False |
| [Download AmneziaWG tools](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/download.yml#L19) | ansible.builtin.include_role | False |
...
| [Extract AmneziaWG go archive](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/install.yml#L11) | ansible.builtin.unarchive | True |
| [Install AmneziaWG kernel module](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/install.yml#L22) | block | True |
| [Check current DKMS status for AmneziaWG module](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/install.yml#L25) | ansible.builtin.command | False |
| [Build and register AmneziaWG module in DKMS](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/install.yml#L31) | block | True |
| [Create temporary directory for kernel module](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/install.yml#L34) | ansible.builtin.tempfile | False |
| [Extract AmneziaWG kernel module archive](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/install.yml#L40) | ansible.builtin.unarchive | False |
| [Prepare DKMS sources using Makefile](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/install.yml#L50) | community.general.make | False |
| [Register AmneziaWG module in DKMS tree](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/install.yml#L57) | ansible.builtin.command | False |
...
| [Install compiled AmneziaWG module into the kernel](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/install.yml#L65) | ansible.builtin.command | False |
| [Install AmneziaWG tools](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/install.yml#L69) | block | False |
| [Extract AmneziaWG tools archive](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/install.yml#L71) | ansible.builtin.unarchive | False |
| [Install AmneziaWG service](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/install.yml#L81) | block | False |
| [Install AmneziaWG service (systemd)](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/amneziawg/tasks/install.yml#L84) | ansible.builtin.template | True |
