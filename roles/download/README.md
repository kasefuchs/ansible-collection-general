...
| ---- | ------ | -------------- |
| [Link current version directory](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/download/tasks/main.yml#L9) | block | False |
| [Create version directory](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/download/tasks/main.yml#L3) | ansible.builtin.file | False |
| [Link current version directory](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/download/tasks/main.yml#L9) | ansible.builtin.file | False |
| [Download files](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/download/tasks/main.yml#L26) | block | False |
| [Check if files already downloaded](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/download/tasks/main.yml#L17) | ansible.builtin.stat | False |
| [Download files](https://codeberg.org/kasefuchs/ansible-collection-general/src/branch/main/roles/download/tasks/main.yml#L26) | ansible.builtin.get_url | True |
